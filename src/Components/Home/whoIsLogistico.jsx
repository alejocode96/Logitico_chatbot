            ...
            <section className={`pt-16 pb-16 w-[90%] mx-auto relative`} id='Section_WhoIsLogistico ' >
                <div className='w-full'>
                    ...
                    <div className="relative  mt-16" style={{ transform: 'none' }}>
                        <div className="absolute top-[1px] right-20 h-2 w-20 [mask-image:linear-gradient(to_right,rgba(217,217,217,0)_0%,#d9d9d9_25%,#d9d9d9_75%,rgba(217,217,217,0)_100%)] md:w-32 lg:w-64">
                            <div className="h-px w-full animate-starlight-right bg-gradient-to-r from-[#C4D600]/0 via-[#C4D600] to-[#C4D600]/0">
                            </div>
                        </div>
                        <div className="rounded-md bg-zinc-950 ring-1 ring-zinc-200 dark:ring-white/10 lg:rounded-2xl">
                            <div className="" style={{ opacity: 1 }}>
                                {isDark ? <img alt="App screenshot" fetchPriority="high" width="4200" height="2490" decoding="async" data-nimg="1" className="rounded-md lg:rounded-2xl" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 40vw" src="../public/page_dark.png" /> :
                                    <img alt="App screenshot" fetchPriority="high" width="4200" height="2490" decoding="async" data-nimg="1" className="rounded-md lg:rounded-2xl" sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 40vw" src="../public/page.png" />}
                            </div>
                        </div>
                        <div className="absolute -bottom-[6.5px] left-20 h-2 w-20 [mask-image:linear-gradient(to_right,rgba(217,217,217,0)_0%,#d9d9d9_25%,#d9d9d9_75%,rgba(217,217,217,0)_100%)] md:w-32 lg:w-64">
