        ...
        <>
            <main className='bg-white dark:bg-[#09090B] h-screen'>
                ...
                <div className="h-[200%] absolute inset-0 z-40 bg-[image:radial-gradient(80%_50%_at_50%_-20%,rgba(196,214,0,0.9),rgba(255,255,255,0))]
                                dark:bg-[image:radial-gradient(80%_50%_at_50%_-20%,rgba(196,214,0,0.4),rgba(255,255,255,0))]"></div>
                {/* svg a cuadros */}
                <svg className="absolute inset-0 z-40 h-[200%] w-full text-zinc-900/15 dark:text-white/10 
